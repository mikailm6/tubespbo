      ...
      <div class="row">
         <div class="col-xs-12">
            ...
            <div class="box box-primary">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               <form role="form" method="post" action="{{ route('py.store') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nama" name="nama_penyewa"/>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Email" name="email_penyewa"/>
                     </div>
                     <div class="form-group">
                        <label for="quantity">Alamat :</label>
                        <textarea class="form-control" placeholder="Alamat" name="alamat_penyewa"></textarea>
                     </div>
                  </div>
                  <!-- /.box-body -->
